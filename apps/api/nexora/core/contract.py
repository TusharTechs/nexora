"""Outcome Contract — formal definition of mission success (ADR-053, ADR-060).

Generated by LLM at mission start via the Unified LLM Client, validated by
Pydantic, consumed by:
